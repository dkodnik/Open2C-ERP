...
//#include "Compiler/ValueRange.h" // 23.10.2010
...
//	RegisterObject(RUNTIME_CLASS(CValueGrid),"Сетка");
	...
	//RegisterObject(RUNTIME_CLASS(CValueRange),"Область"); // 23.10.2010
	//RegisterObject(RUNTIME_CLASS(CValueRange),"Area");// 23.10.2010
